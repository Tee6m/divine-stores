...
<br><br><br><br>
 ...
 <div class="home_content text-center">
		<div class="home_title" style="font-weight: bolder; color:rgb(7, 61, 0)">{{ ucwords($category->name)}}</div>
				...
				<div class="breadcrumbs d-flex flex-column align-items-center justify-content-center">
						<ul class="d-flex flex-row align-items-start justify-content-start text-center">
							...
							<li><a href="category.html" style="font-weight: bolder; color:rgb(0, 0, 0)">Popular</a></li>
							<li style="font-weight: bolder; color:rgb(0, 0, 0)">New Products</li>
						</ul>
					</div>
